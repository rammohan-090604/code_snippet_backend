...
Object.defineProperties(binding, {
    ...
    GoogleAuthCode: { get: utils_1._throwOnAccess.bind(undefined, "GoogleAuthCode"), configurable: true },
    GoogleIdToken: { get: utils_1._throwOnAccess.bind(undefined, "GoogleIdToken"), configurable: true },
    AppCredentials: { get: utils_1._throwOnAccess.bind(undefined, "AppCredentials"), configurable: true },
    UserSubscriptionToken: { get: utils_1._throwOnAccess.bind(undefined, "UserSubscriptionToken"), configurable: true },
    SyncUser: { get: utils_1._throwOnAccess.bind(undefined, "SyncUser"), configurable: true },
    User: { get: utils_1._throwOnAccess.bind(undefined, "User"), configurable: true },
    UserProfile: { get: utils_1._throwOnAccess.bind(undefined, "UserProfile"), configurable: true },
    AppSubscriptionToken: { get: utils_1._throwOnAccess.bind(undefined, "AppSubscriptionToken"), configurable: true },
    App: { get: utils_1._throwOnAccess.bind(undefined, "App"), configurable: true },
    WatchStream: { get: utils_1._throwOnAccess.bind(undefined, "WatchStream"), configurable: true },
    PushClient: { get: utils_1._throwOnAccess.bind(undefined, "PushClient"), configurable: true },
    UsernamePasswordProviderClient: {
        get: utils_1._throwOnAccess.bind(undefined, "UsernamePasswordProviderClient"),
        configurable: true,
    },
    UserApiKeyProviderClient: { get: utils_1._throwOnAccess.bind(undefined, "UserApiKeyProviderClient"), configurable: true },
    LoggerFactory: { get: utils_1._throwOnAccess.bind(undefined, "LoggerFactory"), configurable: true },
    SyncManager: { get: utils_1._throwOnAccess.bind(undefined, "SyncManager"), configurable: true },
    ThreadSafeReference: { get: utils_1._throwOnAccess.bind(undefined, "ThreadSafeReference"), configurable: true },
    AsyncOpenTask: { get: utils_1._throwOnAccess.bind(undefined, "AsyncOpenTask"), configurable: true },
    SyncSession: { get: utils_1._throwOnAccess.bind(undefined, "SyncSession"), configurable: true },
    SslVerifyCallback: { get: utils_1._throwOnAccess.bind(undefined, "SslVerifyCallback"), configurable: true },
    SyncSubscriptionSet: { get: utils_1._throwOnAccess.bind(undefined, "SyncSubscriptionSet"), configurable: true },
    MutableSyncSubscriptionSet: { get: utils_1._throwOnAccess.bind(undefined, "MutableSyncSubscriptionSet"), configurable: true },
    Scheduler: { get: utils_1._throwOnAccess.bind(undefined, "Scheduler"), configurable: true },
    GenericNetworkTransport: { get: utils_1._throwOnAccess.bind(undefined, "GenericNetworkTransport"), configurable: true },
    JsPlatformHelpers: { get: utils_1._throwOnAccess.bind(undefined, "JsPlatformHelpers"), configurable: true },
    WeakSyncSession: { get: utils_1._throwOnAccess.bind(undefined, "WeakSyncSession"), configurable: true },
});
/**
...
function injectNativeModule(nativeModule, extras) {
    ...
    class GoogleAuthCode {
        ...
        static _extract(self) {
            if (!(self instanceof GoogleAuthCode))
                throw new TypeError("Expected a GoogleAuthCode");
            const out = self[_GoogleAuthCode_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed GoogleAuthCode");
            return out;
        }
        static make(code) {
    ...
    class GoogleIdToken {
        ...
        static _extract(self) {
            if (!(self instanceof GoogleIdToken))
                throw new TypeError("Expected a GoogleIdToken");
            const out = self[_GoogleIdToken_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed GoogleIdToken");
            return out;
        }
        static make(token) {
    ...
    class AppCredentials {
        ...
        static _extract(self) {
            if (!(self instanceof AppCredentials))
                throw new TypeError("Expected a AppCredentials");
            const out = self[_AppCredentials_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed AppCredentials");
            return out;
        }
    ...
    class UserSubscriptionToken {
        ...
        static _extract(self) {
            if (!(self instanceof UserSubscriptionToken))
                throw new TypeError("Expected a UserSubscriptionToken");
            const out = self[_UserSubscriptionToken_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed UserSubscriptionToken");
            return out;
        }
    }
    ...
    class SyncUser {
        ...
        static _extract(self) {
            if (!(self instanceof SyncUser))
                throw new TypeError("Expected a SyncUser");
            const out = self[_SyncUser_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed SyncUser");
            return out;
        }
        get isLoggedIn() {
    ...
    class User {
        ...
        static _extract(self) {
            ...
            if (!out)
                throw new TypeError("Received an improperly constructed User");
            return out;
        }
        subscribe(observer) {
        ...
        requestRefreshLocation() {
            return (0, utils_1._promisify)(false, (_cb) => _native_User_request_refresh_location(this[_User_Symbol], _cb));
        }
        requestAccessToken() {
            return (0, utils_1._promisify)(false, (_cb) => _native_User_request_access_token(this[_User_Symbol], _cb));
        }
        trackRealm(path) {
    ...
    class UserProfile {
        ...
        static _extract(self) {
            if (!(self instanceof UserProfile))
                throw new TypeError("Expected a UserProfile");
            const out = self[_UserProfile_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed UserProfile");
            return out;
        }
        data() {
    ...
    class AppSubscriptionToken {
        ...
        static _extract(self) {
            if (!(self instanceof AppSubscriptionToken))
                throw new TypeError("Expected a AppSubscriptionToken");
            const out = self[_AppSubscriptionToken_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed AppSubscriptionToken");
            return out;
        }
    }
    ...
    const _native_App_immediately_run_file_actions = nativeModule.App_immediately_run_file_actions;
    ...
    class App {
        ...
        static _extract(self) {
            if (!(self instanceof App))
                throw new TypeError("Expected a App");
            const out = self[_App_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed App");
            return out;
        }
        logInWithCredentials(credentials) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_log_in_with_credentials(this[_App_Symbol], credentials, _cb));
        }
        logOutUser(user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_log_out_user(this[_App_Symbol], user, _cb));
        }
        refreshCustomData(user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_refresh_custom_data(this[_App_Symbol], user, _cb));
        }
        linkUser(user, credentials) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_link_user(this[_App_Symbol], user, credentials, _cb));
        }
        switchUser(user) {
            return _native_App_switch_user(this[_App_Symbol], user);
        }
        removeUser(user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_remove_user(this[_App_Symbol], user, _cb));
        }
        deleteUser(user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_delete_user(this[_App_Symbol], user, _cb));
        }
        usernamePasswordProviderClient() {
        ...
        callFunction(user, name, args, service_name) {
            return (0, utils_1._promisify)(true, (_cb) => _native_App_call_function(this[_App_Symbol], user, name, args, service_name, _cb));
        }
        ...
        updateBaseUrl(base_url) {
            return (0, utils_1._promisify)(false, (_cb) => _native_App_update_base_url(this[_App_Symbol], base_url, _cb));
        }
        getBaseUrl() {
            return _native_App_get_base_url(this[_App_Symbol]);
        }
        immediatelyRunFileActions(realm_path) {
            return _native_App_immediately_run_file_actions(this[_App_Symbol], realm_path);
        }
    ...
    class WatchStream {
        ...
        static _extract(self) {
            if (!(self instanceof WatchStream))
                throw new TypeError("Expected a WatchStream");
            const out = self[_WatchStream_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed WatchStream");
            return out;
        }
        nextEvent() {
    ...
    class PushClient {
        ...
        static _extract(self) {
            if (!(self instanceof PushClient))
                throw new TypeError("Expected a PushClient");
            const out = self[_PushClient_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed PushClient");
            return out;
        }
        registerDevice(registration_token, sync_user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_PushClient_register_device(this[_PushClient_Symbol], registration_token, sync_user, _cb));
        }
        deregisterDevice(sync_user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_PushClient_deregister_device(this[_PushClient_Symbol], sync_user, _cb));
        }
    }
    ...
    class UsernamePasswordProviderClient {
        ...
        static _extract(self) {
            ...
            if (!out)
                throw new TypeError("Received an improperly constructed UsernamePasswordProviderClient");
            return out;
        }
        registerEmail(email, password) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_register_email(this[_UsernamePasswordProviderClient_Symbol], email, password, _cb));
        }
        retryCustomConfirmation(email) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_retry_custom_confirmation(this[_UsernamePasswordProviderClient_Symbol], email, _cb));
        }
        confirmUser(token, token_id) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_confirm_user(this[_UsernamePasswordProviderClient_Symbol], token, token_id, _cb));
        }
        resendConfirmationEmail(email) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_resend_confirmation_email(this[_UsernamePasswordProviderClient_Symbol], email, _cb));
        }
        resetPassword(password, token, token_id) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_reset_password(this[_UsernamePasswordProviderClient_Symbol], password, token, token_id, _cb));
        }
        sendResetPasswordEmail(email) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_send_reset_password_email(this[_UsernamePasswordProviderClient_Symbol], email, _cb));
        }
        callResetPasswordFunction(email, password, args) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UsernamePasswordProviderClient_call_reset_password_function(this[_UsernamePasswordProviderClient_Symbol], email, password, args, _cb));
        }
    }
    ...
    class UserApiKeyProviderClient {
        ...
        static _extract(self) {
            if (!(self instanceof UserApiKeyProviderClient))
                throw new TypeError("Expected a UserApiKeyProviderClient");
            const out = self[_UserApiKeyProviderClient_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed UserApiKeyProviderClient");
            return out;
        }
        createApiKey(name, user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_create_api_key(this[_UserApiKeyProviderClient_Symbol], name, user, _cb));
        }
        fetchApiKey(id, user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_fetch_api_key(this[_UserApiKeyProviderClient_Symbol], id, user, _cb));
        }
        fetchApiKeys(user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_fetch_api_keys(this[_UserApiKeyProviderClient_Symbol], user, _cb));
        }
        deleteApiKey(id, user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_delete_api_key(this[_UserApiKeyProviderClient_Symbol], id, user, _cb));
        }
        enableApiKey(id, user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_enable_api_key(this[_UserApiKeyProviderClient_Symbol], id, user, _cb));
        }
        disableApiKey(id, user) {
            return (0, utils_1._promisify)(false, (_cb) => _native_UserAPIKeyProviderClient_disable_api_key(this[_UserApiKeyProviderClient_Symbol], id, user, _cb));
        }
    }
    ...
    class SyncManager {
        ...
        static _extract(self) {
            if (!(self instanceof SyncManager))
                throw new TypeError("Expected a SyncManager");
            const out = self[_SyncManager_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed SyncManager");
            return out;
        }
    ...
    const _native_AsyncOpenTask_unregister_download_progress_notifier = nativeModule.AsyncOpenTask_unregister_download_progress_notifier;
    ...
    class AsyncOpenTask {
        ...
        static _extract(self) {
            if (!(self instanceof AsyncOpenTask))
                throw new TypeError("Expected a AsyncOpenTask");
            const out = self[_AsyncOpenTask_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed AsyncOpenTask");
            return out;
        }
        start() {
            return (0, utils_1._promisify)(false, (_cb) => _native_AsyncOpenTask_start(this[_AsyncOpenTask_Symbol], _cb));
        }
        cancel() {
        ...
        unregisterDownloadProgressNotifier(token) {
            return _native_AsyncOpenTask_unregister_download_progress_notifier(this[_AsyncOpenTask_Symbol], token);
        }
        $resetSharedPtr() {
    ...
    const _native_SyncSession_get_file_ident = nativeModule.SyncSession_get_file_ident;
    ...
    class SyncSession {
        ...
        static _extract(self) {
            if (!(self instanceof SyncSession))
                throw new TypeError("Expected a SyncSession");
            const out = self[_SyncSession_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed SyncSession");
            return out;
        }
        waitForUploadCompletion() {
            return (0, utils_1._promisify)(false, (_cb) => _native_SyncSession_wait_for_upload_completion(this[_SyncSession_Symbol], _cb));
        }
        waitForDownloadCompletion() {
            return (0, utils_1._promisify)(false, (_cb) => _native_SyncSession_wait_for_download_completion(this[_SyncSession_Symbol], _cb));
        }
        ...
        getFileIdent() {
            return _native_SyncSession_get_file_ident(this[_SyncSession_Symbol]);
        }
        get state() {
    ...
    class SslVerifyCallback {
        ...
        static _extract(self) {
            if (!(self instanceof SslVerifyCallback))
                throw new TypeError("Expected a SslVerifyCallback");
            const out = self[_SslVerifyCallback_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed SslVerifyCallback");
            return out;
        }
    }
    ...
    class SyncSubscriptionSet {
        ...
        static _extract(self) {
            if (!(self instanceof SyncSubscriptionSet))
                throw new TypeError("Expected a SyncSubscriptionSet");
            const out = self[_SyncSubscriptionSet_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed SyncSubscriptionSet");
            return out;
        }
        makeMutableCopy() {
        ...
        getStateChangeNotification(notify_when) {
            return (0, utils_1._promisify)(false, (_cb) => _native_SyncSubscriptionSet_get_state_change_notification(this[_SyncSubscriptionSet_Symbol], notify_when, _cb));
        }
        findByName(name) {
    ...
    class MutableSyncSubscriptionSet extends SyncSubscriptionSet {
        static _extract(self) {
            if (!(self instanceof MutableSyncSubscriptionSet))
                throw new TypeError("Expected a MutableSyncSubscriptionSet");
            const out = self[_SyncSubscriptionSet_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed MutableSyncSubscriptionSet");
            return out;
        }
        clear() {
    ...
    class GenericNetworkTransport {
        ...
        static _extract(self) {
            if (!(self instanceof GenericNetworkTransport))
                throw new TypeError("Expected a GenericNetworkTransport");
            const out = self[_GenericNetworkTransport_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed GenericNetworkTransport");
            return out;
        }
    }
    ...
    class WeakSyncSession {
        ...
        static _extract(self) {
            if (!(self instanceof WeakSyncSession))
                throw new TypeError("Expected a WeakSyncSession");
            const out = self[_WeakSyncSession_Symbol];
            if (!out)
                throw new TypeError("Received an improperly constructed WeakSyncSession");
            return out;
        }
        rawDereference() {
    ...
    Object.defineProperties(binding, {
        ...
        GoogleAuthCode: { value: GoogleAuthCode, writable: false, configurable: false },
        GoogleIdToken: { value: GoogleIdToken, writable: false, configurable: false },
        AppCredentials: { value: AppCredentials, writable: false, configurable: false },
        UserSubscriptionToken: { value: UserSubscriptionToken, writable: false, configurable: false },
        SyncUser: { value: SyncUser, writable: false, configurable: false },
        User: { value: User, writable: false, configurable: false },
        UserProfile: { value: UserProfile, writable: false, configurable: false },
        AppSubscriptionToken: { value: AppSubscriptionToken, writable: false, configurable: false },
        App: { value: App, writable: false, configurable: false },
        WatchStream: { value: WatchStream, writable: false, configurable: false },
        PushClient: { value: PushClient, writable: false, configurable: false },
        UsernamePasswordProviderClient: { value: UsernamePasswordProviderClient, writable: false, configurable: false },
        UserApiKeyProviderClient: { value: UserApiKeyProviderClient, writable: false, configurable: false },
        LoggerFactory: { value: LoggerFactory, writable: false, configurable: false },
        SyncManager: { value: SyncManager, writable: false, configurable: false },
        ThreadSafeReference: { value: ThreadSafeReference, writable: false, configurable: false },
        AsyncOpenTask: { value: AsyncOpenTask, writable: false, configurable: false },
        SyncSession: { value: SyncSession, writable: false, configurable: false },
        SslVerifyCallback: { value: SslVerifyCallback, writable: false, configurable: false },
        SyncSubscriptionSet: { value: SyncSubscriptionSet, writable: false, configurable: false },
        MutableSyncSubscriptionSet: { value: MutableSyncSubscriptionSet, writable: false, configurable: false },
        Scheduler: { value: Scheduler, writable: false, configurable: false },
        GenericNetworkTransport: { value: GenericNetworkTransport, writable: false, configurable: false },
        JsPlatformHelpers: { value: JsPlatformHelpers, writable: false, configurable: false },
        WeakSyncSession: { value: WeakSyncSession, writable: false, configurable: false },
    });
